  ...
  const pricingPlans = [
    {
      ...
      features: ["Basic analytics", "Up to 10 tables", "Email support"],
      popular: false,
      cta: "Get Started",
    },
    {
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Everything you need to run a modern restaurant, from table
            ...
            {pricingPlans.map((plan, index) => (
              <div
                ...
                className={`bg-background rounded-2xl p-8 border ${
                  plan.popular ? "border-border shadow-lg" : "border-border"
                } relative`}
              >
                {plan.popular && (
      ...
      <section className="py-20 bg-primary">
        <div className="max-w-4xl mx-auto px-6 text-center space-y-8">
          ...
          <p className="text-xl text-primary-foreground/80">
            Join thousands of restaurants already using RestaurantOS to
