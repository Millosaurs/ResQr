                ...
                <div className="flex flex-1 flex-col">
                    <div className="flex flex-col gap-6 p-6">
                        <div className="flex justify-between items-center mb-4">
                            ...
                            <Button size="sm" onClick={() => setOpen(true)}>Create Menu</Button>
                        </div>
                            ...
                            {menus.map((menu) => (
                                <div key={menu.id} className="bg-muted rounded-lg p-4 border border-border flex flex-col gap-2">
                                    ...
                                    <div className="grid grid-cols-4 gap-2 mt-3">
                                        <Button size="icon" variant="ghost" className="flex flex-col items-center justify-center">
                                        ...
                                        <Button size="icon" variant="ghost" className="flex flex-col items-center justify-center text-red-600 hover:text-red-700">
