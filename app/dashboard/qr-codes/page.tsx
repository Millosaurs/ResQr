                ...
                <div className="flex flex-1 flex-col">
                    <div className="flex flex-col gap-6 p-6">
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                            {mockQRCodes.map((qr) => (
                                <div key={qr.id} className="bg-muted rounded-lg p-4 border border-border flex flex-col items-center gap-2">
                                    <img src={qr.qr} alt="QR Preview" className="w-24 h-24 object-contain mb-2" />
